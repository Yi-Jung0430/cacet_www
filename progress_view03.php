        ...
        <div class="col-12">
          ...
          <nav class="mt-3 mt-md-5" aria-label="breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">審委意見
                <span>(期刊論文)</span>
              </li>
            </ol>
          </nav>
          ...
          <div class="detail_box">
            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
              <li class="nav-item" role="presentation">
                <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab" aria-controls="home" aria-selected="true">審查結果 1</button>
              </li>
              <li class="nav-item" role="presentation">
            ...
            <!-- 審查結果 頁籤內容(審查結果)  開始 -->
            <div class="tab-content cu_tabs" id="myTabContent">
              <!-- 審查結果一 開始 -->
