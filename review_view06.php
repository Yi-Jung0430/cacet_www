                ...
                <tbody>
                  <tr>
                    ...
                    <td class="align-top score_th">
                      <input type="text" onfocusout="checkScore_02(this)" class="form-control v_02" placeholder="滿分為 20 分" value="20">
                  ...
                  <tr>
                    ...
                    <!-- v_04 第二欄分數 -->
                    <td class="align-top">
                      <input type="text" onfocusout="checkScore_04(this)" class="form-control v_04" placeholder="滿分為 20 分" value="20">
                  ...
                  <tr>
                    ...
                    <!-- v_06 第三欄分數 -->
                    <td class="align-top">
                      <input type="text" onfocusout="checkScore_06(this)" class="form-control v_06" placeholder="滿分為 25 分" value="25">
                  ...
                  <tr>
                    ...
                    <!-- v_08 第四欄分數 -->
                    <td class="align-top">
                      <input type="text" onfocusout="checkScore_08(this)" class="form-control v_08" placeholder="滿分為 25 分" value="25">
                  ...
                  <tr>
                    ...
                    <!-- v_10 第五欄分數 -->
                    <td class="align-top">
                      <input type="text" onfocusout="checkScore_10(this)" class="form-control v_10" placeholder="滿分為 10 分" value="10">
