                        ...
                        <div id="three" class="tab-inner">
                            <section class="pdf__box">
                                <div class="py-2 text-center">
                                    ...
                                    <a download href="storage/4-APA格式範例.pdf" class="ms-2">下載</a>
                                </div>
                                <div class="rule__pdf">
                        ...
                        <div id="four" class="tab-inner">
                            <section class="pdf__box">
                                <div class="py-2 text-center">
                                    ...
                                    <a download href="storage/以深度學習神經網路實現特徵點遮蔽之人臉偵測.pdf" class="ms-2">下載</a>
                                </div>
                                <div class="rule__pdf">
...
<script>
    ...
    // pdf.js_02 設定 開始
    // PDF檔案路徑
    var url_02 = 'storage/3-正文文稿書寫格式說明.pdf';
    ...
    // pdf.js_03 設定 開始
    // PDF檔案路徑
    var url_03 = 'storage/4-APA格式範例.pdf';
    ...
    // pdf.js_04 設定 開始
    // PDF檔案路徑
    var url_04 = 'storage/以深度學習神經網路實現特徵點遮蔽之人臉偵測.pdf';
